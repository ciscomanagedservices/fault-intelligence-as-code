...
.nav-folder-title[data-path^="wiki/entities"]    { color: var(--wiki-1); }
.nav-folder-title[data-path^="wiki/concepts"]    { color: var(--wiki-2); }
.nav-folder-title[data-path^="wiki/sources"]     { color: var(--wiki-3); }
.nav-folder-title[data-path^="wiki/questions"]   { color: var(--wiki-4); }
.nav-folder-title[data-path^="wiki/comparisons"] { color: var(--wiki-5); }
.nav-folder-title[data-path^="wiki/meta"]        { color: var(--wiki-6); }
...
| `path:wiki/concepts` | Blue (`#4fc1ff`) |
